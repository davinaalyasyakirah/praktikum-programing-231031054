...
mdata = ['PT. XYZ Komputer',
        'JL. BALAIKOTA NO.1 ',
        'Kota Parepare',
        'Davina Alya Syakirah',
        'davinaaismail@gmail.com',
        'Dinda',
        '1 Oktober 2005',]
...
print('-'*77)
print('1.'+'|'+djual[1][0].ljust(13)+'|'+djual[0][0].ljust(19)+'|'+f'Rp{djual[2][0]*r},-'.rjust(15)+'|'+'3'.center(8)+'|'+f'Rp{2*r*djual[2][0]},-'.rjust(14)+'|')
print('2.'+'|'+djual[1][1].ljust(13)+'|'+djual[0][1].ljust(19)+'|'+f'Rp{djual[2][1]*r},-'.rjust(15)+'|'+'3'.center(8)+'|'+f'Rp{2*r*djual[2][1]},-'.rjust(14)+'|')
print('3.'+'|'+djual[1][2].ljust(13)+'|'+djual[0][2].ljust(19)+'|'+f'Rp{djual[2][2]*r},-'.rjust(15)+'|'+'3'.center(8)+'|'+f'Rp{2*r*djual[2][2]},-'.rjust(14)+'|')
print('4.'+'|'+djual[1][3].ljust(13)+'|'+djual[0][3].ljust(19)+'|'+f'Rp{djual[2][3]*r},-'.rjust(15)+'|'+'3'.center(8)+'|'+f'Rp{2*r*djual[2][3]},-'.rjust(14)+'|')
print('5.'+'|'+djual[1][4].ljust(13)+'|'+djual[0][4].ljust(19)+'|'+f'Rp{djual[2][4]*r},-'.rjust(15)+'|'+'3'.center(8)+'|'+f'Rp{2*r*djual[2][4]},-'.rjust(14)+'|')
print('-'*77)
print(f'                                      '+'SUBTOTAL :'.rjust(15)+f'{sum(djual[3])}'.center(8)+'|'+f'Rp{sum(djual[2])*r},-'.rjust(14)+'|')
print('-'*77)
...
mdata = ['Parepare, 25 Oktober 2023',
        'JL. BALAIKOTA NO.1 ',
        'Kota Parepare',
        'Davina Alya Syakirah',
        'davinaaismail@gmail.com',
...
b = mdata[6].capitalize()
#print((mdata[4]+', '+b).rjust(76))
#print('\n')
print(mdata[0].rjust(77))
print('\n'*4)
print(mdata[5].rjust(73))
print(('-'*16).rjust(73))
